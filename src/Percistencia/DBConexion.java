...
//clase para la conixion de la base de datos
public class DBConexion {
    ...
    public static Connection getConexion() throws FileNotFoundException, SQLException{
        ...
        try {
            ...
            String rutaArchivo = directorioActual + File.separator + "\\src\\Percistencia\\configuracion.txt"; // localizamos la ruta que contiene la url, user y password
